...
const Carouselyape = (update) =>{
  ...
  const carouselItem1    = $('<div class="carousel-item red" href="#one!"></div>');
  ...
  const carouselItem2    = $('<div class="carousel-item amber" href="#two!"></div>');
  ...
  const carouselItem3    = $('<div class="carousel-item green" href="#three!"></div>');
